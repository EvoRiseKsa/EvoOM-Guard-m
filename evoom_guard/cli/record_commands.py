...
# ------------------------------------------------------------------------------
"""Typed application adapters for the verdict/evidence record CLI family.
...
command orchestration for record verification, evidence creation, trusted
finalization, and offline bundle verification.
"""
