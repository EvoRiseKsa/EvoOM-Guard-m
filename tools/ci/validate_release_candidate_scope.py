...
# -----------------------------------------------------------------------------
"""Validate the exact, parent-owned v4.4.1 release-candidate scope.
...
class CandidateScopeError(ValueError):
    """The candidate is outside the exact reviewed v4.4.1 release scope."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate the exact parent-owned v4.4.1 release-candidate scope."
    )
