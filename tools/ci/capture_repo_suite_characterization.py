"""Capture/check the frozen repository-suite characterization vector."""
...
from repo_suite_characterization_harness import (  # noqa: E402
    SCHEMA_VERSION,
    canonical_json,
    capture_all,
)
...
def main() -> int:
    ...
    if VECTOR.read_text(encoding="utf-8") != rendered:
        ...
        return 1
    print("Repository-suite characterization matches the frozen vector.")
    return 0
