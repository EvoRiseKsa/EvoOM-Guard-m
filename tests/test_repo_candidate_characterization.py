"""Frozen equivalence gate for repository candidate coordination."""
...
import pytest
from repo_candidate_characterization_harness import (
    CASE_NAMES,
    SCHEMA_VERSION,
    canonical_json,
    capture_case,
...
def test_repo_candidate_vector_metadata_is_exact() -> None:
    frozen = _frozen()
...
def test_frozen_repo_candidate_behavior(
    case_name: str,
    tmp_path: Path,
) -> None:
    ...
    if actual != expected:
        ...
        pytest.fail("repo candidate behavior drifted:\n" + diff)
