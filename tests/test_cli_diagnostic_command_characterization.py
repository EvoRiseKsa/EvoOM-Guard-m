"""Frozen equivalence gates for the bounded diagnostic-command extraction."""
...
from tests.cli_diagnostic_command_characterization_harness import (
    CASE_NAMES,
    SCHEMA_VERSION,
    canonical_json,
    capture_case,
...
VECTOR = (
    ...
    / "fixtures"
    / "refactor-safety"
    / "cli-diagnostic-command-v1.json"
)
...
def test_cli_diagnostic_command_vector_metadata_is_exact() -> None:
    frozen = _frozen()
...
def test_frozen_cli_diagnostic_command_behavior(case_name: str) -> None:
    ...
    if actual != expected:
        ...
        pytest.fail("CLI diagnostic command behavior drifted:\n" + diff)
