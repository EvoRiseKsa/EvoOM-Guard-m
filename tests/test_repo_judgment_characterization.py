"""Frozen equivalence gates for repo-native pre-finalization judgment."""
...
from tests.repo_judgment_characterization_harness import (
    CASE_NAMES,
    SCHEMA_VERSION,
    canonical_json,
    capture_case,
...
def test_repo_judgment_vector_metadata_is_exact() -> None:
    frozen = _frozen()
...
def test_frozen_repo_judgment_behavior(case_name: str) -> None:
    ...
    if actual != expected:
        ...
        pytest.fail("repo-native pre-finalization judgment drifted:\n" + diff)
