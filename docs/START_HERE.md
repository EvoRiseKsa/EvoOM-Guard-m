...
For a new rollout using the current `v4.7.1` release, first run the non-executing
...
understood. These commands are present in `v4.7.1`; the older immutable
...
> authority. Commands below apply to the direct-release-recorded `v4.7.1`
...
Using named profiles from `v4.7.1`?                   → verify runtime evidence; see OPERATING_PROFILES.md
...
[`EVIDENCE_BUNDLES.md`](EVIDENCE_BUNDLES.md). The `v4.7.1` verifier accepts
...
> are included in `v4.7.1`; their packaged no-clobber workflow kit remains
