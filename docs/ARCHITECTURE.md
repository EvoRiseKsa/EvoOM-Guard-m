...
| `execution/judge_environment.py` | Phase-specific setup/suite/pack scratch environments owned by the judgment workspace and located outside the candidate copy. They redirect common home/temp/cache paths without introducing runtime-identity exclusions or claiming a host filesystem sandbox. |
