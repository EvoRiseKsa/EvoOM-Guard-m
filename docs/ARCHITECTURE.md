...
| `verifiers/repo_verifier.py` | **The compatibility orchestrator.** Coordinates repository admission/materialization, verifier-pack pre/post snapshot identity, sticky evidence, phase composition/final projection, and workspace cleanup. It injects live runtime-identity providers into the bounded continuity owner. |
