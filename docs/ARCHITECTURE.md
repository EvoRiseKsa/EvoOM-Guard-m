...
| `verifiers/repo_verifier.py` | **The compatibility orchestrator.** Coordinates repository admission/materialization, runtime-tree continuity, verifier-pack execution and post-snapshot identity, sticky evidence projection, and workspace cleanup. |
