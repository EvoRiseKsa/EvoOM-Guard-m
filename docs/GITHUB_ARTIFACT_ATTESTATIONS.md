...
```bash
gh release download v4.8.1 --repo EvoRiseKsa/EvoOM-Guard-m \
  --pattern evo-guard.pyz \
  --pattern evo-guard.spdx.json \
  --pattern SHA256SUMS
sha256sum --check SHA256SUMS
gh release verify v4.8.1 --repo EvoRiseKsa/EvoOM-Guard-m
```
...
gh attestation verify ./evo-guard.pyz \
  ...
  --source-digest e63e9d806fef38c9dfd3bfb1a0bc1b2d12c58ac8 \
