...
| Version | Status |
| --- | --- |
| `4.8.1.dev0` | Unreleased development source; unsupported; not a consumer release |
| [`v4.8.0`](https://github.com/EvoRiseKsa/EvoOM-Guard-m/releases/tag/v4.8.0) | Latest stable release; supported; maintained signed direct record, not an A-through-H ledger |
