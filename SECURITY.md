...
| Version | Status |
| --- | --- |
| [`v4.4.2`](https://github.com/EvoRiseKsa/EvoOM-Guard-m/releases/tag/v4.4.2) | Latest stable release; supported |
| `4.5.0.dev0` | Unreleased development source; not a consumer release |
