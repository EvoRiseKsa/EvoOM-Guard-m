...
| Version | Status |
| --- | --- |
| `4.9.0.dev0` | Unreleased development source; unsupported; not a consumer release |
| [`v4.8.1`](https://github.com/EvoRiseKsa/EvoOM-Guard-m/releases/tag/v4.8.1) | Latest stable release; supported; maintained signed direct record, not an A-through-H ledger |
...
unsupported `v4.5.0` release and does not cover `v4.6.0`. Do not put a working
bypass, secret, or credential-bearing artifact in the public issue; use the
private route above for a potential vulnerability.
